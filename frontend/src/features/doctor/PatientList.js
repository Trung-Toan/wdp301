    ...
    return (
      <div className="p-6 space-y-6">
        ...
        <div className="flex justify-between items-start border-b pb-3 mb-4">
          ...
          <span
            className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium uppercase shadow-sm ${record.status === "PRIVATE"
        ...
        {record.prescription && (
          <div className="border border-green-300 rounded-xl p-5 bg-green-50 shadow-inner">
            <div className="flex justify-between items-center mb-4">
              ...
              <span
                className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium shadow-sm ${record.prescription.status === "VERIFIED"
