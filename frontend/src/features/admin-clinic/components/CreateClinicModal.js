    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data.ok) {
                ...
                toast.error("Không thể gửi yêu cầu tạo phòng khám: " + res.data.message);
            }
        } catch (error) {
                    ...
                    <div className="border-t pt-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                />
                                {logoPreview && (
                                    <img src={logoPreview} alt="Logo" className="mt-2 w-20 h-20 object-cover rounded border" />
                                )}
                            </div>
                            <div>
                                ...
                                />
                                {bannerPreview && (
                                    <img src={bannerPreview} alt="Banner" className="mt-2 w-full h-20 object-cover rounded border" />
                                )}
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) => setFormData({
                                        ...formData,
                                        address: { ...formData.address, province: e.target.value, ward: "" }
                                    })}
