...
export default function AnonymousFeedback() {
  ...
  const filteredFeedback = feedbacks.filter((fb) => {
    ...
    const matchesRating =
      selectedRating === "all" || fb.ratingType === selectedRating;
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div
          className={`flex items-center p-5 bg-white rounded-lg shadow-sm border gap-4 cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-1 ${
