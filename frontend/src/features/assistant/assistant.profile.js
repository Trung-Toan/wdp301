...
const AssistantProfile = () => {
    ...
    // Map dữ liệu theo response (doctor_id & clinic_id là object)
    useEffect(() => {
            ...
            try {
                ...
                setProfile({
                    ...
                    assistant: {
                        ...
                        type: normType, // CHỈ HIỂN THỊ – KHÔNG CHO SỬA
                        doctor,
                        clinic,
                    },
                });
    ...
    const handleSave = async () => {
        try {
            ...
            const assistant_updated = await ASSISTANT_API.updateProfile(payload);
        ...
        <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-xl p-8 lg:p-10 border border-gray-100">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b pb-4 mb-6">
                    ...
                    <div className="flex flex-wrap space-x-3">
                        <Button
                            ...
                            className={`flex items-center px-4 py-2 font-semibold rounded-lg shadow-md transition duration-300 ${isEditing ? "bg-green-500 hover:bg-green-600" : "bg-blue-600 hover:bg-blue-700"
                                } text-white`}
                        >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    {/* Cột phải: Thông tin cá nhân, Vai trò & Ghi chú, Phân công */}
                    <div className="xl:col-span-2 space-y-8">
                        ...
                        {/* Vai trò & Ghi chú (Vai trò: READ-ONLY) */}
                        <div className="p-6 bg-white rounded-xl shadow-lg border border-gray-100">
                            <h3 className="text-xl font-bold text-blue-700 mb-4 border-b pb-2 flex items-center">
                            ...
                            <div className="mb-2">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(profile.assistant.type || []).length ? (
                                        profile.assistant.type.map((r, idx) => (
                                            <span
                                                key={idx}
                                                className="px-3 py-1 text-xs font-semibold rounded-full bg-gray-100 border border-gray-300 text-gray-800"
                                                title="Vai trò được quản trị thiết lập"
                                            >
                                                {r}
                                            </span>
                                        ))
                                    ) : (
                                        <span className="text-gray-700 font-semibold">Chưa gán vai trò</span>
                                    )}
                                </div>
                                <p className="text-xs text-gray-500 mt-1">
                                    Vai trò do quản trị thiết lập. Liên hệ quản trị viên nếu bạn cần thay đổi.
                                </p>
                            </div>

                            {/* Ghi chú (cho phép chỉnh sửa) */}
                            <InfoRow
                                label="Ghi chú"
                        ...
                        {/* Phân công: hiển thị chi tiết doctor & clinic */}
                        <div className="p-6 bg-white rounded-xl shadow-lg border border-gray-100">
                            <h3 className="text-xl font-bold text-blue-700 mb-4 border-b pb-2 flex items-center">
